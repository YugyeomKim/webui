...
class CustomDataset(torch.utils.data.Dataset):
    def __init__(self, split_file, boxes_dir='../../downloads/ds', rawdata_screenshots_dir='../../downloads/ds', class_map_file="../../metadata/screenrecognition/custom_class_map.json", min_area=10, device_scale=DEVICE_SCALE, max_boxes=200, max_skip_boxes=200, augment_p=0.1):
        ...
        self.random_posterize_applier = transforms.RandomApply([transforms.RandomPosterize(bits=3, p=1)], p=augment_p)
        self.random_solarize_applier = transforms.RandomApply([transforms.RandomSolarize(threshold=250, p=1)], p=augment_p)
...
class CustomDataModule(pl.LightningDataModule):
    def __init__(self, train_split_file="../../downloads/train_split_custom.json", val_split_file="../../downloads/val_split_custom.json", test_split_file="../../downloads/test_split_custom.json", batch_size=20, num_workers=3):
